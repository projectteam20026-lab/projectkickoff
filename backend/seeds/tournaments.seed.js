...
const TEAMS_SET_A = [
  { name: 'نجوم عمان',     logo: '⭐' },
  { name: 'أسود الأردن',  logo: '🦁' },
  { name: 'صقور الجنوب',  logo: '🦅' },
  { name: 'عقبان الشمال', logo: '👑' },
  { name: 'نسور البتراء', logo: '💎' },
  { name: 'ذئاب الشرق',   logo: '🐺' },
  { name: 'بدر الزرقاء',  logo: '🌙' },
  { name: 'فرسان الشمال', logo: '🏇' },
  { name: 'هلال إربد',    logo: '🌙' },
  { name: 'ليوث الأردن',  logo: '🛡️' },
];

const TEAMS_SET_B = [
  { name: 'رعد السلط',     logo: '⚡' },
  { name: 'فجر العقبة',   logo: '☀️' },
  { name: 'برق جرش',      logo: '🎯' },
  { name: 'ثعالب عجلون',  logo: '🦊' },
  { name: 'سهام مادبا',   logo: '🎽' },
  { name: 'قوس الكرك',    logo: '💪' },
  { name: 'نمور الطفيلة', logo: '🐯' },
  { name: 'حراس المفرق',  logo: '🏆' },
];

const TEAMS_SET_C = [
  { name: 'غزلان الجنوب', logo: '🦌' },
  { name: 'طاووس عمان',  logo: '🦚' },
  { name: 'ضباع الشرق',  logo: '😼' },
  { name: 'خيول الغرب',   logo: '🐎' },
  { name: 'أفاعي الوسط', logo: '🐍' },
  { name: 'نحل النجاح',   logo: '🐝' },
  { name: 'أسماك البحر',  logo: '🐟' },
  { name: 'سلاحف الوادي', logo: '🐢' },
];

const TEAMS_SET_D = [
  { name: 'صاعقة عمان',   logo: '⚡' },
  { name: 'أمواج الزرقاء', logo: '🌊' },
  { name: 'شموس إربد',    logo: '🌟' },
  { name: 'قمم السلط',    logo: '🏔️' },
  { name: 'وديان جرش',    logo: '🌿' },
  { name: 'صحارى معان',   logo: '🏜️' },
  { name: 'جبال عجلون',   logo: '⛰️' },
  { name: 'بحيرات المفرق', logo: '💧' },
  { name: 'ريح الشمال',   logo: '🌬️' },
  { name: 'حجارة الكرك',  logo: '🪨' },
  { name: 'نار الجنوب',   logo: '🔥' },
  { name: 'ثلوج الشتاء',  logo: '❄️' },
  { name: 'أمل الأردن',   logo: '💚' },
  { name: 'عزم عمان',     logo: '💪' },
  { name: 'وفاء الوطن',   logo: '🏴' },
  { name: 'فخر الأمة',    logo: '🌹' },
];
