    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <section className="py-16 bg-white px-4">
        <div className="max-w-7xl mx-auto">
          {/* Section header — في RTL: أول عنصر يظهر على اليمين */}
          <div className="flex justify-between items-center mb-10">
            <div className="text-start">
              <span className="text-emerald-500 text-sm font-bold block mb-1">الملاعب المتاحة</span>
              <h2 className="text-3xl font-black text-slate-900">أحدث الملاعب المضافة</h2>
            </div>
            <button
              onClick={() => navigate('/explore')}
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-lg font-black text-slate-900">{field.pricePerHour} <span className="text-sm font-bold text-emerald-600">د.أ</span></span>
                    </div>
                    <button
      ...
      {/* ══════════════════════════════════════════════════════════════
          4. TOURNAMENT CTA — مخفي للاعب المسجّل
      ══════════════════════════════════════════════════════════════ */}
      {!isPlayer && <section className="py-20 bg-slate-900 relative overflow-hidden">
        {/* Background pattern */}
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          {/* في RTL: أول عنصر في الـ grid يظهر على اليمين */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">

            {/* يمين: صورة اللاعب — أول في DOM = يمين في RTL */}
            ...
            {/* يسار: النص — ثاني في DOM = يسار في RTL */}
            <div>
              ...
              {tournaments.map(t => (
                ...
                >
                  ...
                  <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-6 relative overflow-hidden">
                    ...
                    <h3 className="text-white font-black text-xl mt-3 leading-tight relative z-10">
                      {t.name}
                    </h3>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-xs text-slate-400 mt-1">
                        {t.maxTeams - t.teamsCount} مقعد متبقي
                      </p>
                    </div>
